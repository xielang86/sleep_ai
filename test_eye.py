...
pose = mp_pose.Pose(static_image_mode=True, min_detection_confidence=0.05, min_tracking_confidence=0.1)
...
while cap.isOpened() and n < 30:
  ...
  for landmark in [landmarks.landmark[i] for i in range(6,24)]:
